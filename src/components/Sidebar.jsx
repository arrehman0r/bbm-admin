    ...
    >
      ...
      >
        ...
        >
          ...
          <ListItemButton onClick={() => dispatch(setDashboardOption("Dashboard"))} sx={{ backgroundColor: selectedOption === "Dashboard" ? '#581E47' : "#fff" , color: selectedOption === "Dashboard" ? "white" : "#581E47",
                '&:hover': {
                  color: 'black',
                },}} >
            <DashboardIcon />
          ...
          <ListItemButton onClick={() => dispatch(setDashboardOption("Booking Engine"))} sx={{ backgroundColor: selectedOption === "Booking Engine" ? '#581E47' : "#fff", color: selectedOption === "Booking Engine" ? "white" : "#581E47",
                '&:hover': {
                  color: 'black',
                },}}  >
            <AirplaneTicketIcon />
