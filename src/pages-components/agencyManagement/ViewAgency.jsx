...
export default function ViewAgency() {
  ...
  return (
    <React.Fragment>
      ...
      <Box className="SearchAndFilters-tabletUp" sx={{ display: { xs: 'none', sm: 'flex' }, flexWrap: 'wrap', gap: 1.5 }}>
        ...
        >
          <thead>
            <tr>
              ...
              <th><Link underline="none" color="primary" onClick={() => setOrder(order === 'asc' ? 'desc' : 'asc')}>Agency Name</Link></th>
              <th>Status</th>
